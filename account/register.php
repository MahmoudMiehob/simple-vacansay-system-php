...
<body>
    <div>
                            ...
                            <div class="card-body p-5">
                                ...
                                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                                    ...
                                    <div data-mdb-input-init class="form-outline mb-4">
                                        ...
                                        <label class="form-label" for="subscribe">subscribe for sent new jobs to your email</label>
                                    </div>
        ...
        if (isset($_POST["register"])) {
            ...
            $sql = "INSERT INTO users (name, email ,password, isAdmin ,subscribe ) VALUES (?, ?, ?, ? , ?)";

            $stmt = $conn->prepare($sql);
            $isadmin = 0;
            $stmt->bind_param("ssssi", $name, $email, $hashed_password, $isadmin ,$subscribe);
